  ...
  const handleSelectSingleMeal = async (dayId: string, mealType: string) => {
    try {
      ...
      const addDietResponse = await axios.post(
        "https://projet-amine-back-q6mpanbk2-raguigs-projects.vercel.app/api/patients/diets",
        dietData,
        {
          headers: {
      ...
      await axios.put(
        `https://projet-amine-back-q6mpanbk2-raguigs-projects.vercel.app/api/patients/visits/${visitId}/assign-diet`,
